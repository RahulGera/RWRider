...
- (void)setup;
- (void)setupWithWindow:(UIWindow * _Nonnull)window;
- (UINavigationController * _Nonnull)root SWIFT_WARN_UNUSED_RESULT;
...
SWIFT_CLASS("_TtC7RWRider18AppDelegateWrapper")
...
@interface AppDelegateWrapper (SWIFT_EXTENSION(RWRider)) <UNUserNotificationCenterDelegate>
- (void)userNotificationCenter:(UNUserNotificationCenter * _Nonnull)center willPresentNotification:(UNNotification * _Nonnull)notification withCompletionHandler:(void (^ _Nonnull)(UNNotificationPresentationOptions))completionHandler SWIFT_AVAILABILITY(ios,introduced=10.0);
@end
...
SWIFT_CLASS("_TtC7RWRider14NibLoadingView")
...
SWIFT_CLASS("_TtC7RWRider16SwiftCountryView")
@interface SwiftCountryView : NibLoadingView
...
+ (UIImage * _Nullable)imageFromFrameworkWithName:(NSString * _Nonnull)name SWIFT_WARN_UNUSED_RESULT;
@end
...
- (CAGradientLayer * _Nonnull)newGradientBorderLayer SWIFT_WARN_UNUSED_RESULT;
