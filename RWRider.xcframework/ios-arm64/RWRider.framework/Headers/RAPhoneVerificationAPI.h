...
+ (void)verifyOTP:(NSString *)code phoneNumber:(NSString *)phoneNumber clientCode:(NSString *)clientCode token:(NSString *)token withCompletion:(void(^)(BOOL success, NSError *error))completion;
@end
